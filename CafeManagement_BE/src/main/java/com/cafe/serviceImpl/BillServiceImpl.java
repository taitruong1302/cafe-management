...
public class BillServiceImpl implements BillService{
	...
	public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
		try {
			...
			if(validateRequestMap(requestMap)) {
				...
				JSONArray jsonArray = CafeUtils.getJsonArrayFromString((String)requestMap.get("product_detail"));
	...
	private void insertBill(Map<String, Object> requestMap) {
		try {
			...
			bill.setTotal(Float.parseFloat((String)requestMap.get("total_amount")));
			bill.setProductDetail((String)requestMap.get("product_detail"));
	...
	private boolean validateRequestMap(Map<String, Object> requestMap) {
		return requestMap.containsKey("name") && requestMap.containsKey("contact_number") && requestMap.containsKey("email") && requestMap.containsKey("payment_method") &&
				requestMap.containsKey("product_detail") &&
	...
	public ResponseEntity<List<Bill>> getBills() {
		...
		if (jwtFilter.isAdmin()) {
			...
			list = billDao.findByCreateBy(jwtFilter.getCurrentUser());
		}
	...
	public ResponseEntity<String> deleteBill(Long id) {
		try {
			...
			return CafeUtils.getResponseEntity("Bill does not exist.", HttpStatus.BAD_REQUEST);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		return CafeUtils.getResponseEntity(CafeConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
